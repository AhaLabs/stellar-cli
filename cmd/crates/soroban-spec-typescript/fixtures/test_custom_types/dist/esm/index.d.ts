...
export declare class Contract {
    ...
    }) => Promise<R extends "simulated" ? {
        txUnsigned: string;
        simulation: SorobanClient.SorobanRpc.SimulateTransactionResponse;
    } : R extends "full" ? {
        txUnsigned: string;
        simulation: SorobanClient.SorobanRpc.SimulateTransactionResponse;
        txSigned?: string | undefined;
        sendTransactionResponse?: SorobanClient.SorobanRpc.SendTransactionResponse | undefined;
        getTransactionResponse?: SorobanClient.SorobanRpc.GetTransactionResponse | undefined;
        getTransactionResponseAll?: SorobanClient.SorobanRpc.GetTransactionResponse[] | undefined;
    } : R extends undefined ? {
        txUnsigned: string;
        simulation: SorobanClient.SorobanRpc.SimulateTransactionResponse;
        txSigned?: string | undefined;
    ...
    u32FailOnEven: <R extends "simulated" | "full" | undefined = undefined>({ u32_ }: {
         ...
         */
        secondsToWait?: number | undefined;
    }) => Promise<Err<Error_> | (R extends "simulated" ? {
        txUnsigned: string;
        simulation: SorobanClient.SorobanRpc.SimulateTransactionResponse;
    } : R extends "full" ? {
        txUnsigned: string;
        ...
        getTransactionResponse?: SorobanClient.SorobanRpc.GetTransactionResponse | undefined;
        getTransactionResponseAll?: SorobanClient.SorobanRpc.GetTransactionResponse[] | undefined;
        result: Err<Error_> | Ok<number, Error_> | undefined;
    } : {
        txUnsigned: string;
        simulation: SorobanClient.SorobanRpc.SimulateTransactionResponse;
        txSigned?: string | undefined;
